...
// ==========================================================
// ТРУБА С ИЗГИБОМ 90° В СЕРЕДИНЕ
// До Y = 0  → направление +Y
// После Y = 0 → плавный поворот → направление +X
// ==========================================================


// ==========================================================
// ТРУБА — ТОЛЬКО ИЗГИБ 90° + ГОРИЗОНТАЛЬНЫЕ УЧАСТКИ
// ==========================================================


// ==========================================================
// ПУЧОК РАЗОРВАННЫХ НИТЕЙ
// 90° изгиб → длинные горизонтальные рваные участки
// Линии разнесены по Z и слегка гуляют по Y
// ==========================================================
...
// ---- изгиб ----
		...
		// ---- нить 2 ----
		// начало приближено к концу Л1-1
		NewLine();
		...
		// ---- нить 2 ----
		// начало рядом с концом предыдущего
		NewLine();
