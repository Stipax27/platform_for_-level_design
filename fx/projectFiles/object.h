...
//====================
		...
		AddPointToLine({ 140,0,-49 });
		AddPointToLine({ 280,0,-91 });
		AddPointToLine({ 420,0,-140 });
		...
		NewLine();
		AddPointToLine({ 420,0,-140 });
		AddPointToLine({ 364,0,-245 });
		AddPointToLine({ 308,0,-350 });
		AddPointToLine({ 245,0,-455 });
		...
		NewLine();
		AddPointToLine({ 420,0,-140 });
		AddPointToLine({ 525,0,-112 });
		AddPointToLine({ 630,0,-84 });
		AddPointToLine({ 735,0,-56 });
		...
		NewLine();
		AddPointToLine({ 420,0,-140 });
		AddPointToLine({ 490,0,-350 });
		AddPointToLine({ 560,0,-560 });
		AddPointToLine({ 630,0,-770 });
		...
		NewLine();
		AddPointToLine({ 630,0,-770 });
		AddPointToLine({ 630,0,-1001 });
		AddPointToLine({ 630,0,-1232 });
		AddPointToLine({ 630,0,-1470 });
		...
		NewLine();
		AddPointToLine({ 630,0,-1470 });
		AddPointToLine({ 840,0,-1631 });
		AddPointToLine({ 1050,0,-1792 });
		AddPointToLine({ 1260,0,-1960 });
		...
		NewLine();
		AddPointToLine({ 630,0,-770 });
		AddPointToLine({ 819,0,-910 });
		AddPointToLine({ 1001,0,-1050 });
		AddPointToLine({ 1190,0,-1190 });
		...
		NewLine();
		AddPointToLine({ 1190,0,-1190 });
		AddPointToLine({ 1400,0,-1379 });
		AddPointToLine({ 1610,0,-1561 });
		AddPointToLine({ 1820,0,-1750 });

		//====================
		// 2 -> 17
		//====================
		NewLine();
		AddPointToLine({ 280,0,490 });
		AddPointToLine({ 651,0,406 });
		AddPointToLine({ 1029,0,322 });
		AddPointToLine({ 1400,0,245 });
		...
		NewLine();
		AddPointToLine({ 735,0,-56 });
		AddPointToLine({ 959,0,42 });
		AddPointToLine({ 1183,0,147 });
		AddPointToLine({ 1400,0,245 });
		...
		NewLine();
		AddPointToLine({ 1400,0,245 });
		AddPointToLine({ 1610,0,399 });
		AddPointToLine({ 1820,0,546 });
		AddPointToLine({ 2030,0,700 });
		...
		NewLine();
		AddPointToLine({ 1400,0,245 });
		AddPointToLine({ 1519,0,70 });
		AddPointToLine({ 1631,0,-105 });
		AddPointToLine({ 1750,0,-280 });
		...
		NewLine();
		AddPointToLine({ 1750,0,-280 });
		AddPointToLine({ 1890,0,-581 });
		AddPointToLine({ 2030,0,-882 });
		AddPointToLine({ 2170,0,-1190 });
		...
		NewLine();
		AddPointToLine({ 1750,0,-280 });
		AddPointToLine({ 1960,0,-406 });
		AddPointToLine({ 2170,0,-539 });
		AddPointToLine({ 2380,0,-665 });
		...
		NewLine();
		AddPointToLine({ 2380,0,-665 });
		AddPointToLine({ 2471,0,-665 });
		AddPointToLine({ 2569,0,-665 });
		AddPointToLine({ 2660,0,-665 });
		...
		NewLine();
		AddPointToLine({ 2660,0,-665 });
		AddPointToLine({ 2779,0,-609 });
		AddPointToLine({ 2891,0,-546 });
		AddPointToLine({ 3010,0,-490 });
